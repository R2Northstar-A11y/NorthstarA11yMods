...
void function InitMainMenuPanel()
{
    ...
    Hud_AddEventHandler( Hud_GetChild( Hud_GetChild( file.menu, "MainMenuPanel" ), "MainMenuButton0" ), UIE_GET_FOCUS, FocusHandle_MainMenuButton0 )
	...
	Hud_AddEventHandler( file.spotlightButtons[0], UIE_GET_FOCUS, FocusHandle_Spotlight0)
	Hud_AddEventHandler( file.spotlightButtons[1], UIE_GET_FOCUS, FocusHandle_Spotlight1)
	Hud_AddEventHandler( file.spotlightButtons[2], UIE_GET_FOCUS, FocusHandle_Spotlight2)
...
void function FocusHandle_MainMenuButton0( var button ) {
    var text = Localize("#QUIT")
    thread TTSsay(text)
}
void function FocusHandle_Spotlight0( var button ) {
    thread TTSsay(expect string( NSGetCustomMainMenuPromoData( eMainMenuPromoDataProperty.largeButtonTitle ) ))
}
void function FocusHandle_Spotlight1( var button ) {
    thread TTSsay(expect string( NSGetCustomMainMenuPromoData( eMainMenuPromoDataProperty.smallButton1Title ) ))
}
void function FocusHandle_Spotlight2( var button ) {
    thread TTSsay(expect string( NSGetCustomMainMenuPromoData( eMainMenuPromoDataProperty.smallButton2Title ) ))
}